...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommandLogCommandsUiState&&(identical(other.showAddForm, showAddForm) || other.showAddForm == showAddForm)&&(identical(other.loadingCommandId, loadingCommandId) || other.loadingCommandId == loadingCommandId));
}
...
@override
String toString() {
  return 'CommandLogCommandsUiState(showAddForm: $showAddForm, loadingCommandId: $loadingCommandId)';
}
...
class _CommandLogCommandsUiState extends CommandLogCommandsUiState {
  const _CommandLogCommandsUiState({this.showAddForm = false, this.loadingCommandId}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommandLogCommandsUiState&&(identical(other.showAddForm, showAddForm) || other.showAddForm == showAddForm)&&(identical(other.loadingCommandId, loadingCommandId) || other.loadingCommandId == loadingCommandId));
}
