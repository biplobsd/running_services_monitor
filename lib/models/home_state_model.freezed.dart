...
// Loading & Error
 bool get isLoading; bool get shizukuReady; String? get errorMessage;// App Data
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeStateModel&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.shizukuReady, shizukuReady) || other.shizukuReady == shizukuReady)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&const DeepCollectionEquality().equals(other.allApps, allApps)&&const DeepCollectionEquality().equals(other.userApps, userApps)&&const DeepCollectionEquality().equals(other.systemApps, systemApps)&&(identical(other.totalRamKb, totalRamKb) || other.totalRamKb == totalRamKb)&&(identical(other.freeRamKb, freeRamKb) || other.freeRamKb == freeRamKb)&&(identical(other.usedRamKb, usedRamKb) || other.usedRamKb == usedRamKb)&&(identical(other.appsRamKb, appsRamKb) || other.appsRamKb == appsRamKb)&&(identical(other.isAutoUpdateEnabled, isAutoUpdateEnabled) || other.isAutoUpdateEnabled == isAutoUpdateEnabled)&&(identical(other.isSearching, isSearching) || other.isSearching == isSearching)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,shizukuReady,errorMessage,const DeepCollectionEquality().hash(allApps),const DeepCollectionEquality().hash(userApps),const DeepCollectionEquality().hash(systemApps),totalRamKb,freeRamKb,usedRamKb,appsRamKb,isAutoUpdateEnabled,isSearching,searchQuery);

@override
String toString() {
  return 'HomeStateModel(isLoading: $isLoading, shizukuReady: $shizukuReady, errorMessage: $errorMessage, allApps: $allApps, userApps: $userApps, systemApps: $systemApps, totalRamKb: $totalRamKb, freeRamKb: $freeRamKb, usedRamKb: $usedRamKb, appsRamKb: $appsRamKb, isAutoUpdateEnabled: $isAutoUpdateEnabled, isSearching: $isSearching, searchQuery: $searchQuery)';
}
...
@useResult
$Res call({
 bool isLoading, bool shizukuReady, String? errorMessage, List<AppProcessInfo> allApps, List<AppProcessInfo> userApps, List<AppProcessInfo> systemApps, double totalRamKb, double freeRamKb, double usedRamKb, double appsRamKb, bool isAutoUpdateEnabled, bool isSearching, String searchQuery
});
...
/// Create a copy of HomeStateModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? shizukuReady = null,Object? errorMessage = freezed,Object? allApps = null,Object? userApps = null,Object? systemApps = null,Object? totalRamKb = null,Object? freeRamKb = null,Object? usedRamKb = null,Object? appsRamKb = null,Object? isAutoUpdateEnabled = null,Object? isSearching = null,Object? searchQuery = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool shizukuReady,  String? errorMessage,  List<AppProcessInfo> allApps,  List<AppProcessInfo> userApps,  List<AppProcessInfo> systemApps,  double totalRamKb,  double freeRamKb,  double usedRamKb,  double appsRamKb,  bool isAutoUpdateEnabled,  bool isSearching,  String searchQuery)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeStateModel() when $default != null:
return $default(_that.isLoading,_that.shizukuReady,_that.errorMessage,_that.allApps,_that.userApps,_that.systemApps,_that.totalRamKb,_that.freeRamKb,_that.usedRamKb,_that.appsRamKb,_that.isAutoUpdateEnabled,_that.isSearching,_that.searchQuery);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool shizukuReady,  String? errorMessage,  List<AppProcessInfo> allApps,  List<AppProcessInfo> userApps,  List<AppProcessInfo> systemApps,  double totalRamKb,  double freeRamKb,  double usedRamKb,  double appsRamKb,  bool isAutoUpdateEnabled,  bool isSearching,  String searchQuery)  $default,) {final _that = this;
switch (_that) {
case _HomeStateModel():
return $default(_that.isLoading,_that.shizukuReady,_that.errorMessage,_that.allApps,_that.userApps,_that.systemApps,_that.totalRamKb,_that.freeRamKb,_that.usedRamKb,_that.appsRamKb,_that.isAutoUpdateEnabled,_that.isSearching,_that.searchQuery);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool shizukuReady,  String? errorMessage,  List<AppProcessInfo> allApps,  List<AppProcessInfo> userApps,  List<AppProcessInfo> systemApps,  double totalRamKb,  double freeRamKb,  double usedRamKb,  double appsRamKb,  bool isAutoUpdateEnabled,  bool isSearching,  String searchQuery)?  $default,) {final _that = this;
switch (_that) {
case _HomeStateModel() when $default != null:
return $default(_that.isLoading,_that.shizukuReady,_that.errorMessage,_that.allApps,_that.userApps,_that.systemApps,_that.totalRamKb,_that.freeRamKb,_that.usedRamKb,_that.appsRamKb,_that.isAutoUpdateEnabled,_that.isSearching,_that.searchQuery);case _:
  return null;
...
class _HomeStateModel implements HomeStateModel {
  const _HomeStateModel({this.isLoading = false, this.shizukuReady = false, this.errorMessage, final  List<AppProcessInfo> allApps = const [], final  List<AppProcessInfo> userApps = const [], final  List<AppProcessInfo> systemApps = const [], this.totalRamKb = 0.0, this.freeRamKb = 0.0, this.usedRamKb = 0.0, this.appsRamKb = 0.0, this.isAutoUpdateEnabled = false, this.isSearching = false, this.searchQuery = ''}): _allApps = allApps,_userApps = userApps,_systemApps = systemApps;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeStateModel&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.shizukuReady, shizukuReady) || other.shizukuReady == shizukuReady)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&const DeepCollectionEquality().equals(other._allApps, _allApps)&&const DeepCollectionEquality().equals(other._userApps, _userApps)&&const DeepCollectionEquality().equals(other._systemApps, _systemApps)&&(identical(other.totalRamKb, totalRamKb) || other.totalRamKb == totalRamKb)&&(identical(other.freeRamKb, freeRamKb) || other.freeRamKb == freeRamKb)&&(identical(other.usedRamKb, usedRamKb) || other.usedRamKb == usedRamKb)&&(identical(other.appsRamKb, appsRamKb) || other.appsRamKb == appsRamKb)&&(identical(other.isAutoUpdateEnabled, isAutoUpdateEnabled) || other.isAutoUpdateEnabled == isAutoUpdateEnabled)&&(identical(other.isSearching, isSearching) || other.isSearching == isSearching)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,shizukuReady,errorMessage,const DeepCollectionEquality().hash(_allApps),const DeepCollectionEquality().hash(_userApps),const DeepCollectionEquality().hash(_systemApps),totalRamKb,freeRamKb,usedRamKb,appsRamKb,isAutoUpdateEnabled,isSearching,searchQuery);
...
/// Create a copy of HomeStateModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? shizukuReady = null,Object? errorMessage = freezed,Object? allApps = null,Object? userApps = null,Object? systemApps = null,Object? totalRamKb = null,Object? freeRamKb = null,Object? usedRamKb = null,Object? appsRamKb = null,Object? isAutoUpdateEnabled = null,Object? isSearching = null,Object? searchQuery = null,}) {
