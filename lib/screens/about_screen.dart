...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(context.loc.about, style: AppStyles.headlineStyle),
        ),
                    ...
                    builder: (context, contributors) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          ...contributors.map(
                            (contributor) =>
                                ContributorListTile(contributor: contributor),
                          ),
                        ],
                      );
                    },
